...
// Cek apakah notifikasi sudah ditampilkan dalam sesi browser ini
if (!sessionStorage.getItem("hasShownLoginNotification")) {
    ...
    // Tandai bahwa notifikasi telah ditampilkan untuk sesi ini
...
function getGreeting() {
    ...
    if (hours >= 5 && hours < 12) {
        return "Selamat pagi, " + userName + "! <br>Semoga harimu menyenangkan.";
    } else if (hours >= 12 && hours < 18) {
        return "Selamat siang, " + userName + "! <br>Semoga harimu produktif.";
    } else if (hours >= 18 && hours < 22) {
        return "Selamat malam, " + userName + "! <br>Semoga harimu menyenangkan.";
    } else {
        return "Selamat istirahat, " + userName + "! <br>Semoga tidurmu nyenyak.";
    }
}
